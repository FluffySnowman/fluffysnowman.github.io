...
So you gotta load up these tools on your computer now. You can use the advanced package tool `apt` to install these tools. `sudo apt-get install aircrack-ng wireshark nmap airgeddon`.